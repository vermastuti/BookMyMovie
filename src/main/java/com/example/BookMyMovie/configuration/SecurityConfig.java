...
//                        .requestMatchers("/admin/**").hasAuthority(UserProfile.Role.ADMIN.name())
                        .requestMatchers("/api/v1/admin/**").hasAuthority(UserProfile.Role.ADMIN.name())
                        .requestMatchers("/api/v1/user/**").hasAnyAuthority(UserProfile.Role.CUSTOMER.name(), UserProfile.Role.ADMIN.name())
